import { Logo } from '@/app/libre/components/logo'
        ...
        <footer role="contentinfo" className="py-8 sm:py-20 lg:pt-32">
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                ...
                <div className="flex flex-wrap justify-between gap-4">
                    ...
                    <div
                        className="ring-foreground/5 bg-card flex items-center gap-2 rounded-full border border-transparent py-1 pl-2 pr-4 shadow ring-1">
                        <div className="relative flex size-3">
                            <span
                                className="duration-1500 absolute inset-0 block size-full animate-pulse rounded-full bg-emerald-100"></span>
