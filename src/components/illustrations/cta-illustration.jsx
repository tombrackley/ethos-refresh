export const CtaIllustration = () => {
    return (
        <div className="max-lg:hidden">
            <div
                className="relative [--color-border-illustration:--alpha(var(--color-zinc-950)/10%)] [--color-border:--alpha(var(--color-zinc-950)/10%)]">
                <div
                    className="h-120 relative mx-auto grid max-w-6xl grid-cols-3 overflow-hidden rounded-2xl lg:px-12">
