export function AskEthosSparkle({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <defs>
        <linearGradient id="ask-ethos-sparkle" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#3CD7C5" />
          <stop offset="100%" stopColor="#A8FD8C" />
        </linearGradient>
      </defs>
      <path
