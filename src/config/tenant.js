  ...
  default: {
    ...
    pages: {
      ...
      control: {
        ...
        kpis: [
          { label: 'Compliance Score', value: '87%', delta: '0.0%', dir: 'flat', primary: true },
          { label: 'Active Matters', value: '47', delta: '+2', dir: 'up' },
          { label: 'Utilization', value: '78%', delta: '+3.2%', dir: 'up' },
          { label: 'Revenue MTD', value: '$2.4M', delta: '+12%', dir: 'up' },
        ],
        matters: [
      ...
      vault: {
        ...
        stages: [
          { label: 'Baseline', filled: true, current: false },
          { label: 'Good', filled: true, current: false },
          { label: 'Effective', filled: true, current: true },
          { label: 'Supercharged', filled: false, current: false },
        ],
        folders: [
          { name: 'Corporate Records',
            suggested: [
              { id: 'cr-constitution', label: 'Company Constitution' },
              { id: 'cr-shareholder',  label: 'Shareholder Agreement' },
              { id: 'cr-delegation',   label: 'Delegation of Authority Matrix' },
              { id: 'cr-agm',          label: 'AGM Minutes' },
              { id: 'cr-share-reg',    label: 'Share Register' },
              { id: 'cr-directors',    label: 'Directors Register' },
            ],
          },
          { name: 'Board & Committees',
            suggested: [
              { id: 'bc-charter',      label: 'Board Charter' },
              { id: 'bc-audit',        label: 'Audit Committee Charter' },
              { id: 'bc-risk',         label: 'Risk Committee Charter' },
              { id: 'bc-nomination',   label: 'Nomination Committee Charter' },
              { id: 'bc-calendar',     label: 'Board Meeting Calendar' },
              { id: 'bc-evaluation',   label: 'Board Evaluation Framework' },
            ],
          },
          { name: 'Policies & Frameworks',
            suggested: [
              { id: 'pf-privacy',       label: 'Privacy Policy' },
              { id: 'pf-conflict',      label: 'Conflict of Interest Policy' },
              { id: 'pf-ethics',        label: 'Code of Ethics' },
              { id: 'pf-whistleblower', label: 'Whistleblower Policy' },
              { id: 'pf-retention',     label: 'Data Retention Policy' },
              { id: 'pf-risk',          label: 'Risk Management Framework' },
              { id: 'pf-aup',           label: 'Acceptable Use Policy' },
            ],
          },
          { name: 'Contracts & Agreements',
            suggested: [
              { id: 'ca-msa',         label: 'Master Service Agreement' },
              { id: 'ca-nda',         label: 'Non-Disclosure Agreement' },
              { id: 'ca-supplier',    label: 'Supplier Agreement' },
              { id: 'ca-engagement',  label: 'Client Engagement Letter' },
              { id: 'ca-lease',       label: 'Office Lease Agreement' },
              { id: 'ca-employment',  label: 'Employment Contract Template' },
            ],
          },
          { name: 'Regulatory & Compliance',
            suggested: [
              { id: 'rc-annual',      label: 'Annual Compliance Report' },
              { id: 'rc-aml',         label: 'AML/CTF Framework' },
              { id: 'rc-sanctions',   label: 'Sanctions Screening Procedure' },
              { id: 'rc-reporting',   label: 'Regulatory Reporting Plan' },
              { id: 'rc-privacy',     label: 'Privacy Impact Assessment' },
              { id: 'rc-incident',    label: 'Incident Response Procedure' },
            ],
          },
          { name: 'Insurance & Licences',
            suggested: [
              { id: 'il-pi',          label: 'Professional Indemnity Certificate' },
              { id: 'il-public',      label: 'Public Liability Certificate' },
              { id: 'il-cyber',       label: 'Cyber Insurance Certificate' },
              { id: 'il-business',    label: 'Business Licence' },
              { id: 'il-industry',    label: 'Industry Licences Register' },
            ],
          },
        ],
        files: [
          { id: 1, name: 'Board Charter 2025.pdf',            folder: 'Board & Committees',      modified: '7 Dec 2025', uploader: 'RR', status: 'Current', source: 'cloud', fulfills: 'bc-charter' },
          { id: 2, name: 'Privacy Policy v3.2.pdf',           folder: 'Policies & Frameworks',   modified: '7 Dec 2025', uploader: 'RR', status: 'Review',  source: 'cloud', fulfills: 'pf-privacy' },
          { id: 3, name: 'Vendor NDA Template.docx',          folder: 'Contracts & Agreements',  modified: '7 Dec 2025', uploader: 'JW', status: 'Good',    source: 'cloud', fulfills: 'ca-nda' },
          { id: 4, name: 'Risk Management Framework.pdf',     folder: 'Policies & Frameworks',   modified: '6 Dec 2025', uploader: 'SM', status: 'Good',    source: 'cloud', fulfills: 'pf-risk' },
          { id: 5, name: 'Conflict of Interest Policy.pdf',   folder: 'Policies & Frameworks',   modified: '5 Dec 2025', uploader: 'RR', status: 'Review',  source: 'sync',  fulfills: 'pf-conflict' },
          { id: 6, name: 'Client Engagement Letter.docx',     folder: 'Contracts & Agreements',  modified: '4 Dec 2025', uploader: 'JW', status: 'Good',    source: 'sync',  fulfills: 'ca-engagement' },
          { id: 7, name: 'Annual Compliance Report 2024.pdf', folder: 'Regulatory & Compliance', modified: '3 Dec 2025', uploader: 'KL', status: 'Good',    source: 'sync',  fulfills: 'rc-annual' },
          { id: 8, name: 'Data Retention Policy v2.pdf',      folder: 'Policies & Frameworks',   modified: '2 Dec 2025', uploader: 'RR', status: 'Good',    source: 'cloud', fulfills: 'pf-retention' },
        ],
      },
      ...
      govern: {
        ...
        kpis: [
          { label: 'Board Health Score', value: '92%', delta: '+1.5%', dir: 'up', primary: true },
          { label: 'Upcoming Meetings', value: '4', delta: '+1', dir: 'up' },
          { label: 'Policies on Track', value: '88%', delta: '+2%', dir: 'up' },
          { label: 'Open Actions', value: '7', delta: '-2', dir: 'up', invert: true },
        ],
        boards: [
      ...
      comply: {
        ...
        kpis: [
          { label: 'Compliance Score',   value: '87%', delta: '0.0%', dir: 'flat', primary: true },
          { label: 'Active Obligations', value: '124', delta: '+3',   dir: 'up' },
          { label: 'Open Incidents',     value: '5',   delta: '-1',   dir: 'up',   invert: true },
          { label: 'Risk Score',         value: '6.4', delta: '-0.3', dir: 'up',   invert: true },
          { label: 'Audit Readiness',    value: '78%', delta: '+4%',  dir: 'up' },
        ],
      },
  ...
  migration: {
    ...
    pages: {
      ...
      vault: {
        ...
        folders: [
          { name: 'Visa Applications', count: 34 },
          { name: 'Sponsorship Files', count: 18 },
          { name: 'Tribunal Appeals', count: 9 },
          { name: 'Client Identity Docs', count: 42 },
          { name: 'Skills Assessments', count: 15 },
          { name: 'Medical & Character', count: 28 },
          { name: 'MARA Compliance', count: 12 },
          { name: 'Correspondence', count: 23 },
        ],
        files: [
          { id: 1, name: 'Chen — Form 47SP Partner Visa.pdf', category: 'Visa Applications', modified: '7 Dec 2025', uploader: 'JW', status: 'Current', source: 'cloud' },
          { id: 2, name: 'Patel — Nomination Form 187.pdf', category: 'Sponsorship Files', modified: '7 Dec 2025', uploader: 'KL', status: 'Review', source: 'cloud' },
          { id: 3, name: 'Al-Rashid — Protection Claims Statement.docx', category: 'Tribunal Appeals', modified: '6 Dec 2025', uploader: 'SM', status: 'Review', source: 'cloud' },
          { id: 4, name: 'Kim — Skills Assessment (ACS).pdf', category: 'Skills Assessments', modified: '6 Dec 2025', uploader: 'DP', status: 'Good', source: 'cloud' },
          { id: 5, name: 'Santos — Citizenship Evidence Bundle.pdf', category: 'Visa Applications', modified: '5 Dec 2025', uploader: 'JW', status: 'Good', source: 'sync' },
          { id: 6, name: 'MARA CPD Record 2025.pdf', category: 'MARA Compliance', modified: '4 Dec 2025', uploader: 'JW', status: 'Current', source: 'sync' },
          { id: 7, name: 'Nguyen — AAT Submission Bundle.pdf', category: 'Tribunal Appeals', modified: '3 Dec 2025', uploader: 'SM', status: 'Good', source: 'sync' },
          { id: 8, name: 'Fee Agreement Template v4.docx', category: 'MARA Compliance', modified: '2 Dec 2025', uploader: 'JW', status: 'Good', source: 'cloud' },
        ],
      },
  ...
  fshd: {
    ...
    pages: {
      ...
      vault: {
        ...
        folders: [
          { name: 'Governance Docs', count: 24 },
          { name: 'Grant Applications', count: 18 },
          { name: 'Research Papers', count: 42 },
          { name: 'Fundraising Materials', count: 31 },
          { name: 'Financial Reports', count: 16 },
          { name: 'Ethics Approvals', count: 12 },
          { name: 'Board Papers', count: 28 },
          { name: 'Donor Communications', count: 19 },
        ],
        files: [
          { id: 1, name: 'FSHD Global Constitution 2024.pdf', category: 'Governance Docs', modified: '15 Jan 2026', uploader: 'NC', status: 'Current', source: 'cloud' },
          { id: 2, name: 'NHMRC Grant Application — Biomarker Study.pdf', category: 'Grant Applications', modified: '10 Feb 2026', uploader: 'LI', status: 'Review', source: 'cloud' },
          { id: 3, name: 'Gene Therapy Phase II Protocol v3.pdf', category: 'Research Papers', modified: '8 Feb 2026', uploader: 'LI', status: 'Current', source: 'cloud' },
          { id: 4, name: 'Chocolate Ball 2026 Sponsorship Prospectus.pdf', category: 'Fundraising Materials', modified: '5 Feb 2026', uploader: 'EW', status: 'Current', source: 'cloud' },
          { id: 5, name: 'FY2025 Audited Financial Statements.pdf', category: 'Financial Reports', modified: '30 Jan 2026', uploader: 'EW', status: 'Good', source: 'sync' },
          { id: 6, name: 'HREC Approval — Gene Therapy Trial.pdf', category: 'Ethics Approvals', modified: '20 Jan 2026', uploader: 'LI', status: 'Review', source: 'sync' },
          { id: 7, name: 'Board Meeting Minutes — Feb 2026.pdf', category: 'Board Papers', modified: '12 Feb 2026', uploader: 'NC', status: 'Good', source: 'sync' },
          { id: 8, name: 'ACNC Annual Information Statement 2025.pdf', category: 'Governance Docs', modified: '28 Jan 2026', uploader: 'EW', status: 'Good', source: 'cloud' },
        ],
      },
...
configs.gallagherbassett = {
  ...
  pages: {
    ...
    vault: {
      ...
      folders: [
        { name: 'Scheme & Agent Agreements', count: 22 },
        { name: 'Regulatory Correspondence', count: 31 },
        { name: 'Privacy & Incident Response', count: 18 },
        { name: 'Litigation & AFCA', count: 26 },
        { name: 'Employment & IR', count: 19 },
        { name: 'Board & Committee Papers', count: 34 },
        { name: 'Vendor & MSA Library', count: 41 },
        { name: 'Policies & Playbooks', count: 27 },
      ],
      files: [
        { id: 1, name: 'icare NSW Agent Scheme Agreement — Draft v4.docx', category: 'Scheme & Agent Agreements', modified: '20 Apr 2026', uploader: 'DP', status: 'Review', source: 'cloud' },
        { id: 2, name: 'ASIC AFS Licence Variation — Response Pack.pdf', category: 'Regulatory Correspondence', modified: '19 Apr 2026', uploader: 'MR', status: 'Review', source: 'cloud' },
        { id: 3, name: 'Motor Claims Privacy Incident — NDB Assessment.docx', category: 'Privacy & Incident Response', modified: '21 Apr 2026', uploader: 'PN', status: 'Current', source: 'cloud' },
        { id: 4, name: 'AFCA Motor Injury Dispute — Defence Outline.docx', category: 'Litigation & AFCA', modified: '18 Apr 2026', uploader: 'KL', status: 'Review', source: 'cloud' },
        { id: 5, name: 'Brisbane Ops Unfair Dismissal — Position Paper.pdf', category: 'Employment & IR', modified: '17 Apr 2026', uploader: 'RL', status: 'Good', source: 'sync' },
        { id: 6, name: 'Risk & Compliance Committee — April Pack.pdf', category: 'Board & Committee Papers', modified: '15 Apr 2026', uploader: 'SB', status: 'Current', source: 'sync' },
        { id: 7, name: 'Azure Cloud MSA — GB Paper v3.docx', category: 'Vendor & MSA Library', modified: '16 Apr 2026', uploader: 'DP', status: 'Review', source: 'cloud' },
        { id: 8, name: 'AI Use Policy — Internal Adoption Framework v1.docx', category: 'Policies & Playbooks', modified: '14 Apr 2026', uploader: 'JW', status: 'Good', source: 'cloud' },
      ],
    },
